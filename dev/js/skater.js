...
const skaterLegsTL = gsap.timeline({repeat: -1, yoyo: true, defaults: { 
  ...
  skaterLegsTL.from("#left-leg", {duration: .7})
  .from("#left-leg", {yPercent:100, duration: .2, scaleY:0})
  .to("#right-leg", {yPercent:100, duration: .2, scaleY:-0}, "-=.2")
  .from("#left-leg", {duration: .7})
  ;
...
const scarfTL = gsap.timeline({repeat: -1, yoyo: true, defaults: { 
  ...
  scarfTL.fromTo("#scarf", {scaleY:1, scaleX:1, yPercent:100, duration: 1, rotate: 170}, {scaleY:.8, scaleX:.9, yPercent:100, duration: 1, rotate: 180})
  ;
...
.fromTo("#dragon-path-finish",{drawSVG:"0%"}, {duration: 1.1, drawSVG:"100%"}, "-=3.35")
.fromTo("#dragon",{alpha:.2}, {duration: 1.5, alpha:1}, "-=2.5")
.fromTo("#dragon-path-finish",{alpha:.2}, {duration: 1.5, alpha:1}, "-=2.5")
